...
TOOLS_DATA_FIXTURE["run_iskay_optimizer"] = {
    ...
    "inputSchema": {
        "properties": {
            ...
            "problem_type": {"title": "Problem Type", "type": "string"},
            "backend_name": {"title": "Backend Name", "type": "string"},
        ...
        "required": ["problem", "problem_type", "backend_name", "instance", "options"],
        "title": "run_iskay_optimizerArguments",
        "type": "object",
    },
    "annotations": None,
}
...
TOOLS_DATA_FIXTURE["run_qctrl_optimizer"] = {
    ...
    "inputSchema": {
        "properties": {
            "problem": {"title": "Problem", "type": "string"},
            "problem_type": {"title": "Problem Type", "type": "string"},
            "backend_name": {"title": "Backend Name", "type": "string"},
            "instance": {"title": "Instance", "type": "string"},
            "options": {
        ...
        "required": ["problem", "problem_type", "backend_name", "instance", "options"],
        "title": "run_qctrl_optimizerArguments",
        "type": "object",
    },
    "annotations": None,
}
...
TOOLS_DATA_FIXTURE["run_qunasys_quri_chemistry"] = {
    ...
    "inputSchema": {
        ...
        "required": ["molecule"],
        "title": "run_qunasys_quri_chemistryArguments",
        "type": "object",
    },
    "annotations": None,
}
...
TOOLS_DATA_FIXTURE["run_dpo_solver"] = {
    ...
    "inputSchema": {
        "properties": {
            ...
            "ansatz_settings": {
                "additionalProperties": True,
                "title": "Ansatz Settings",
                "type": "object",
            },
            "backend_name": {"title": "Backend Name", "type": "string"},
            "previous_session_id": {
                "default": [],
                "title": "previous_session_id",
                "type": "string",
            },
            "apply_postprocess": {
                "default": True,
                "title": "Apply Postprocess",
                "type": "boolean",
            },
        },
        "required": [
